...
- **RFC 2119 Compliance**: Key words such as MUST, SHOULD, and MAY follow [RFC 2119](https://datatracker.ietf.org/doc/html/rfc2119) definitions.
- **SPEC.md**: The local specification file (required as defined in "SPEC.md").
...
*Compliance terminology (such as required, recommended, and optional actions) follow the defined glossary above.*
